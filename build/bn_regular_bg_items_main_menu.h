...
//	Total size: 224 + 8256 + 2048 = 10528
//
...
#define main_menu_bn_gfxTilesLen 8256
extern const bn::tile main_menu_bn_gfxTiles[258];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item main_menu(
            regular_bg_tiles_item(span<const tile>(main_menu_bn_gfxTiles, 258), bpp_mode::BPP_8, compression_type::NONE), 
