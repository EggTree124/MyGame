...
//	+ 132 tiles (t|f reduced) not compressed
//	+ regular map (flat), not compressed, 32x32 
//	Total size: 224 + 8448 + 2048 = 10720
//
...
#define main_menu_bn_gfxTilesLen 8448
extern const bn::tile main_menu_bn_gfxTiles[264];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item main_menu(
            regular_bg_tiles_item(span<const tile>(main_menu_bn_gfxTiles, 264), bpp_mode::BPP_8, compression_type::NONE), 
