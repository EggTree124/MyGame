...
#define red_bn_gfxTilesLen 32160
extern const bn::tile red_bn_gfxTiles[1005];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item red(
            regular_bg_tiles_item(span<const tile>(red_bn_gfxTiles, 1005), bpp_mode::BPP_4, compression_type::NONE), 
