...
#define red_bn_gfxTilesLen 128
extern const bn::tile red_bn_gfxTiles[4];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item red(
            regular_bg_tiles_item(span<const tile>(red_bn_gfxTiles, 4), bpp_mode::BPP_8, compression_type::NONE), 
