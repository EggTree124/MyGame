...
//	Total size: 128 + 11648 + 2048 = 13824
//
...
#define bloated_bn_gfxTilesLen 11648
extern const bn::tile bloated_bn_gfxTiles[364];

#define bloated_bn_gfxMapLen 2048
extern const bn::regular_bg_map_cell bloated_bn_gfxMap[1024];

#define bloated_bn_gfxPalLen 128
extern const bn::color bloated_bn_gfxPal[64];
...
namespace bn::regular_bg_items
{
    constexpr inline regular_bg_item bloated(
            regular_bg_tiles_item(span<const tile>(bloated_bn_gfxTiles, 364), bpp_mode::BPP_8, compression_type::NONE), 
            bg_palette_item(span<const color>(bloated_bn_gfxPal, 64), bpp_mode::BPP_8, compression_type::NONE),
